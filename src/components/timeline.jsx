...
const timelineData = [
	...
	{
		icon: <FaCode className="text-blue-500 dark:text-cyan-400" size={24} />,
	...
	{
		icon: <FaDatabase className="text-blue-500 dark:text-cyan-400" size={24} />,
	...
	{
		icon: <FaProjectDiagram className="text-blue-500 dark:text-cyan-400" size={24} />,
	...
	{
		icon: <FaBrain className="text-blue-500 dark:text-cyan-400" size={24} />,
	...
	{
		icon: <FaCertificate className="text-blue-500 dark:text-cyan-400" size={24} />,
	...
	{
		icon: <FaLaptopCode className="text-blue-500 dark:text-cyan-400" size={24} />,
	...
	{
		icon: <FaBriefcase className="text-blue-500 dark:text-cyan-400" size={24} />,
	...
	{
		icon: <FaStar className="text-blue-500 dark:text-cyan-400" size={24} />,
...
export default function Timeline() {
	return (
		<section id="timeline" className="max-w-7xl mx-auto px-6 py-24 scroll-mt-24 text-slate-900 dark:text-white">
			<Reveal>
				<div className="mb-8">
					<p className="text-xs font-semibold uppercase tracking-[0.24em] text-blue-600 dark:text-cyan-400">Timeline</p>
					...
					{timelineData.map((item, idx) => (
						<Reveal key={idx}>
							<div className="mb-12 flex items-start group">
								<div className="absolute -left-[30px] flex items-center justify-center w-14 h-14 rounded-full bg-white dark:bg-slate-950 shadow-[0_0_20px_rgba(59,130,246,0.3)] dark:shadow-[0_0_20px_rgba(6,182,212,0.3)] border-[3px] border-blue-100 dark:border-slate-800 transition-transform duration-500 group-hover:scale-110">
									{item.icon}
								</div>
								<div className="ml-8">
									<h3 className="text-2xl font-bold mb-1 text-slate-900 dark:text-white group-hover:text-blue-600 dark:group-hover:text-cyan-400 transition-colors">
										{item.title}
									</h3>
